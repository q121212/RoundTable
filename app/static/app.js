(() => {
  ...
  const messages = {
    en: {
      ...
      "stats.here_now": "here now",
      "stats.moved_on": "moved on",
      "stats.time_bar_help": "Average time a ticket spent in this status before moving to another one.",
      "stats.time_in_status": "Time in status",
      "stats.time_in_status_help": "Average time tickets spend in each status before moving on, reconstructed from the action log.",
    ...
    ru: {
      ...
      "stats.avg_time": "Сред. время",
      "stats.here_now": "сейчас здесь",
      "stats.moved_on": "ушли дальше",
      "stats.time_bar_help": "Среднее время, которое тикет провёл в этом статусе до перехода в другой.",
      "stats.time_in_status": "Время в статусе",
      "stats.time_in_status_help": "Среднее время, которое тикеты проводят в каждом статусе до перехода дальше, по журналу действий.",
